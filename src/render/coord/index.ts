 ...
 *
 * Type contract: `Viewport`, `GenomicCoord`, `SemanticLevel` are imported
 * from `~state/types` (lead-frozen). Do NOT redeclare them here.
 */

import type { GenomicCoord, SemanticLevel, Viewport } from '~state/types';
